...
final case class AirQuality(var url: String, var stationName: String, var dominentPol: String, var aqi: Option[Int] = None, var index: Int, var STM: Option[Long] = None, var iaqi: aqicn.avro.message.Iaqi, var city: aqicn.avro.message.City) extends org.apache.avro.specific.SpecificRecordBase {
